...
for (i in 1:n.sec) {
  ...
  if (nrows>=th.nrows && nrows.2017>=th.sur ){
    ...
    temp.metrics.incep=as.data.frame(cbind(mtd.ret,ytd.ret,ann.ret.incep,ann.std.incep,downrisk.incep,drawdown.incep
...
outfile=paste(u.name,"_incep_output.csv",sep="")
