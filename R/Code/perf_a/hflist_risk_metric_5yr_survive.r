...
outfile=paste(u.name,"_rcustom_5yr.csv",sep="")
file.dir.out=paste(pathname,outfile,sep="")
#write.csv(df.metrics.5, file.dir.out)
library(xlsx)
xlsx.dir.out=paste(pathname,curmon.chr,"_5yr_output.xlsx",sep="")
xlsx.sheetname=paste(u.name,"_rcustom_5yr",sep="")
#has to be new worksheet
write.xlsx(df.metrics.5,xlsx.dir.out,sheetName=xlsx.sheetname,append=TRUE,showNA=FALSE)
