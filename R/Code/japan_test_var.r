...
tmp1n7.zoo<-merge(tmp1n6.zoo,factor7.zoo,all=FALSE)
tmp7n8.zoo<-merge(factor7.zoo,factor8.zoo,all=FALSE)
tmp6n7.zoo<-merge(factor6.zoo,factor7.zoo,all=FALSE)
tmp3467.zoo<-merge(tmp3n4.zoo,tmp6n7.zoo,all=FALSE)

tmp_f.zoo<-merge(tmp3467.zoo,factor9.zoo,all=FALSE)
...
#t.zoo<-merge(price1.zoo, tmp2n8.zoo, all=FALSE)
