...
for n=4:4
    ...
    for m=8:8
        ...
        [b]=opti_lag(adjcls1_row,adjcls2_row,tries);
        x=1:s;
        [pks1,locs1]=findpeaks1(adjcls1_row,'MINPEAKHEIGHT',mean(adjcls1_row),'MINPEAKDISTANCE',b(1,1),'THRESHOLD',b(2,1));
        [pks2,locs2]=findpeaks1(adjcls2_row,'MINPEAKHEIGHT',mean(adjcls2_row),'MINPEAKDISTANCE',b(3,1),'THRESHOLD',b(4,1));
