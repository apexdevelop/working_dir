...
d_ranges={'d5:s51','d5:n39','d5:j31','d5:d18','d5:m41','d5:i28','d5:i33','d5:h30','d5:p28','d5:g23','d5:e30','d5:e30','d5:d30','d5:h24','d5:cm190'};
% shname='display';
sh_idx=1;
...
%% VAR process
        ...
        for q=0:0
            ...
            for q1=4:4
                ...
                [s,ret_v,r,newmetric]=factor_backtest3(v_rtn,Zspread,v_factor,z_fpx,enter_factor,v_causal,enter_causal,exit_causal,date(M+1:end),effect(n,m));
