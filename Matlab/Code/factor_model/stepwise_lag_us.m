...
clearvars;
% sh_idx=12;
cd('Y:/working_directory/Matlab/Data/factor');
javaaddpath('C:\blp\DAPI\APIv3\JavaAPI\v3.10.1.1\lib\blpapi3.jar');
v_names={'oil','shipping','utility','steel','coal','display','solar','bank','aluminum','auto','machinery'};
n_universe=size(v_names,2);
d_ranges={'b6:b31','b6:b39','b6:b29','b6:b38','b6:b35','b6:b39','b6:b36','b6:b46','b6:b29','b6:b22','b6:b28'};
w_ranges={'b40:b46','b40:b47','b30:b30','b39:b42','b36:b36','b40:b41','b37:b42','b50:b50','b30:b43','b23:b38','b29:b29'};

direction_ranges={'d15:i15','d15:g15','d15:h15','d15:h15','d15:g15','d15:k15','d15:h15','d15:p15','d15:g15','d15:g15','d15:g15'};
TH_ranges={'d3:i3','d3:g3','d3:h3','d3:h3','d3:g3','d3:k3','d3:h3','d3:p3','d3:g3','d3:g3','d3:g3'};
para_ranges={'d4:i14','d4:g14','d4:h14','d4:h14','d4:g14','d4:k14','d4:h14','d4:p14','d4:g14','d4:g14','d4:g14'};
exit_ranges={'d16:i16','d16:g16','d16:h16','d16:h16','d16:g16','d16:k16','d16:h16','d16:p16','d16:g16','d16:g16','d16:g16'};
enter_ranges={'d17:i17','d17:g17','d17:h17','d17:h17','d17:g17','d17:k17','d17:h17','d17:p17','d17:g17','d17:g17','d17:g17'};

beta_ranges={'d6:i31','d6:g47','d6:h29','d6:h42','d6:g35','d6:k41','d6:h42','d6:p47','d6:g43','d6:g38','d6:g28'};
fchg_ranges={'k6:o35','q6:u47','j6:n29','k6:o42','i6:m35','m6:q41','j6:n42','r6:v47','i6:m43','i6:m38','i6:m28'};
...
filename1='factors_multi_coint_us.xlsx';
filename2='stepwise_para_us.xlsx';
filename3='stepwise_output_us.xlsx';
%filename4='stepwise_trade.xlsx';
filename4='stepwise_trade_us.xlsm';

for sh_idx=11:n_universe
