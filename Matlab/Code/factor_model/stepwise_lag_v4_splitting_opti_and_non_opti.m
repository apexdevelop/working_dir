...
d_ranges={'b6:b39','b6:b39','b6:b29','b6:b32','b6:b38','b6:b35','b6:b39','b6:b40','b6:b36','b6:b46','b6:b43','b6:b11','b6:b29','b6:b22','b6:b37','b6:b28','b6:b23'};
w_ranges={'b40:b46','b40:b47','b30:b30','b33:b33','b39:b42','b36:b36','b40:b41','b41:b42','b37:b42','b50:b50','b44:b44','b12:b12','b30:b43','b23:b38','b39:b39','b29:b29','b24:b29'};
...
beta_ranges={'d6:g35','d6:n47','d6:h29','d6:d32','d6:i42','d6:f35','d6:g41','d6:d42','d6:h43','d6:p45','d6:g44','d6:d11','d6:e43','d6:g38'};
fchg_ranges={'i6:m35','q6:u47','j6:n29','f6:j32','k6:o42','h6:l35','i6:m41','f6:j42','j6:n43','r6:v45','i6:m44','f6:j11','g6:k43','i6:m38'};
...
%              zscr(j-M+1:end)=(v_residual(j-M+1:end)-mean_res_N)/std_res_N;
    ...
    Metrics_p=[];
    for Signal_p=-1:0.5:-1
        [metric_p,s_p,ret_v_p,r_trade_p,rp]=z_backtest_oneside(1,rtn_eb(M:end,:),zscr,Signal_p,hp_TH,tday1(M:end));
        ...
        if countp==1
           ...
           vp_Rtn=supervertcat(vp_Rtn,rp);
        end
        Names_p=[Names_p txt2(q)];
    end
    ...
    Metrics_n=[];
    for Signal_n=1:0.5:1
        [metric_n,sn,ret_v_n,r_trade_n,rn]=z_backtest_oneside(-1,rtn_eb(M:end,:),zscr,Signal_n,hp_TH,tday1(M:end));
        ...
        if countn==1
           ...
           vn_Rtn=supervertcat(vn_Rtn,rn);
        end
        
        Names_n=[Names_n txt2(q)];
    end
...
%     [current_metric,s1,ret_v1,r_trade1,r1]=z_backtest_oneside1(v_para(:,q),v_direction(q),rtn_eb(M:end,:),zscr,v_TH(q),hp_TH,tday1(M:end),v_exit(q),v_enter(q));    
