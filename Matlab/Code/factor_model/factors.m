function av_ret=factors(v_rtn,Zspread,f_ret,enter_fret,v_causal,enter_causal,exit_causal,tday,effect)
...
%output=[av_ret,winp,trades,hp,last_exit,last_enter,direction];