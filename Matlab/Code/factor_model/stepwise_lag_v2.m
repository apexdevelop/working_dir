...
beta_ranges={'d6:g29','d6:n47','d6:h29','d6:d32','d6:i41','d6:f34','d6:g41','d6:d42','d6:i42','d6:p46','d6:g44','d6:d9','d6:e42','d6:g38'};
fchg_ranges={'i6:m29','q6:u47','j6:n29','f6:j32','k6:o41','h6:l34','i6:m41','f6:j42','k6:o42','r6:v46','i6:m44','f6:j9','g6:k42','i6:m38'};
...
%              mean_res_N=mean(v_residual(j-M+1:j-M+N));
             mean_res_M=mean(reg.res);
             zscr(j-M+1:j-M+N)=(v_residual(j-M+1:j-M+N)-mean_res_M)/reg.RMSE;
%              zscr(j-M+1:j-M+N)=(v_residual(j-M+1:j-M+N)-mean_res_N)/reg.RMSE;
             ...
             zscr(j-M+1:end)=(v_residual(j-M+1:end)-mean_res_M)/reg.RMSE;
%              zscr(j-M+1:end)=(v_residual(j-M+1:end)-mean_res_N)/reg.RMSE;
    ...
    chg_inmodel=100*(log_XY3(end,:)-log_XY3(1,:));
    %mat_fchg_inmodel{1,q}=transpose(fchg_inmodel);
    output_beta=[coint_b(1);-1*coint_b(2:end)];
    temp_cell=num2cell([output_beta transpose(chg_inmodel)]);
