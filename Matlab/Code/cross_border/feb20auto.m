...
[at,apx,anames]=importdata('input_ticker','feb21','a2:a88','last_price',window,2);

% import local price data
[lt,lpx,lnames]=importdata('input_ticker','feb21','b2:b88','last_price',window,3);
% import shares per adr
[spa,txt]=xlsread('input_ticker','feb21','c2:c88');
% import local ticker currency
[num,crn]=xlsread('input_ticker','feb21','d2:d88');
...
% xlswrite('ipod result 20130228',[A Am B Bm C Cm],'Sheet1','f2');
