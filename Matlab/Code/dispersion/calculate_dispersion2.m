...
[num,txt]=xlsread('dispersion matlab','Universe','c1:j1000');
...
%         temp_rtn(IX(1:n_top_vol))=[];
%         temp_rtn(IX(n_top_vol+1:end-n_top_vol+1))=[];
        temp_rtn=temp_rtn(IX(n_top_vol+1:end-n_top_vol+1));
