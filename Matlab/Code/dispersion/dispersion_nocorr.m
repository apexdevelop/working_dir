...
[num,txt]=xlsread('dispersion matlab','Universe','c1:c1000'); %c-j
...
%         newmetric=backtest_nocorr(rtn_Y(corr_window:end,1),z_disp_mov(corr_window:end),enter_disp,exit_disp,tday1);         
        newmetric=backtest_nocorr4(rtn_Y(corr_window:end,1),z_disp_mov(corr_window:end),enter_disp,exit_disp,tday1); 
        if newmetric(5)>=4
        g_mat_winp=[g_mat_winp;newmetric(3)];
...
%         newmetric2=backtest_nocorr(rtn_Y(corr_window:end,1),z_disp_mov(corr_window:end),enter_disp,exit_disp,tday1);
        newmetric2=backtest_nocorr4(rtn_Y(corr_window:end,1),z_disp_mov(corr_window:end),enter_disp,exit_disp,tday1);
        c_mat_winp=[c_mat_winp;newmetric2(3)];
