...
%fmincg is used in octave, fminunc is used in Matlab
%but if use fminunc here, it will take forever. so use customized fmincg
%function in the logistic folder
