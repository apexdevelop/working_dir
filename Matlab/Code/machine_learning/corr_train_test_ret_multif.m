...
function accuracy=corr_train_test_ret_multif(rtn_Y,disp_col,v_factor1,z_turnover_mov,tday1,M,N,l_pattern,l_np,prc,w1,w2,w3,w4,w5,w6)
%% Calculate inputs
...
% TestpatternMetrics=[rebalance_test_Xlevel;rebalance_test_Xve_avg;rebalance_imaxtest_X;rebalance_imintest_X;rebalance_Xstart_end_test];