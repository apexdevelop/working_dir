...
matTestperf=[];%[R,Beta,Alpha,Err]
matTotalperf=[]; %[R,Beta,Alpha,Err]
if new_train==1
   ...
   for N=1:maxlag
       ...
       toc
       matTestperf=[matTestperf v_test_perf];
       matTotalperf=[matTotalperf v_total_perf];
   end
end
%% Backtesting
matRet=[];
