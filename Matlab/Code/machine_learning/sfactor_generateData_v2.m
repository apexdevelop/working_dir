% clearvars;
% sh_idx=5;
function[cell_px,cell_ret,cell_exret,cell_ob,cell_date]= sfactor_generateData_v2(sh_idx, opt_save,startdate,enddate)
%% generate Data
% javaaddpath('C:\blp\DAPI\APIv3\JavaAPI\v3.10.1.1\lib\blpapi3.jar');
[edates,eprices,ertns,fdates,fprices,frtns,bdates,bprices,brtns]= sf_datafeed(startdate,enddate);
