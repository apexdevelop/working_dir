...
function [metric,m_ABR,m_CAR,m_SAR,m_SCAR,C_max,I_max,C_min,I_min]=event_study_revenue_surprise_v2(input_ticker,input_date,input_window,start_date,is_regress,is_adjcar)                  
...
%          m_VCAR=temp_VCAR*100;
         ...
         m_SAR=temp_ABR./temp_VAR;
         m_SCAR=temp_CAR./temp_VCAR;
