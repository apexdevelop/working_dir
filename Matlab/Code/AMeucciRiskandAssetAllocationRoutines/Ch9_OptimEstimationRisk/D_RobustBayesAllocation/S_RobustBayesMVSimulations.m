% this script computes and displays in the mean-variance coordinates
% - the sample M-V frontier
% - the Bayesian M-V frontier
% - the robust Bayesian M-V frontier
% the experiment is repeated for a number J of simulations
...
N=10;   % number of assets in the market
