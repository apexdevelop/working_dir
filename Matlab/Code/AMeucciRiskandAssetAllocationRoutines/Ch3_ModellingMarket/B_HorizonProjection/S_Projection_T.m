...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% parameters
nu=4; % t-distribution's degree of freedom
mu=2; % t-distribution's location parameter
sig=3; % t-distribution's scatter parameter
T=20; % multiple of the estimation period to the investment horizon 
