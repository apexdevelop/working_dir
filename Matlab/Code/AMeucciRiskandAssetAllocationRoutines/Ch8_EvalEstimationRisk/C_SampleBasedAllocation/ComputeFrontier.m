function [E,V,MV_ExpectedValue,MV_Variance,SR_ExpectedValue,SR_Variance]=ComputeFrontier(Market,InvestorProfile,Vertical_Limits)
...
Top=Vertical_Limits(end);
Bottom=Vertical_Limits(1);
Step=(Top-Bottom)/100;
E=[Bottom : Step : Top];
V=[];
for i=1:length(E);
