...
[names date price]=blp_simple('input_sector_small',inputs,inputr,500); %import data set from bloomberg
...
% xlswrite('coint_result_2013_0507',stk1_col,inputs,'b1');
% xlswrite('coint_result_2013_0507',stk2_col,inputs,'c1');
% xlswrite('coint_result_2013_0507',[NUM_T TR AR HP WinP B abs(B) RSQR STAT L SL SC abs(SC)],inputs,'d2');
