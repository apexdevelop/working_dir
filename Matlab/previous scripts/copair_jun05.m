...
ranges={'a3:a15','a3:a9','a2:a16','a2:a11','a2:a15','a2:a7','a2:a12','a2:a3'};
ranges2={'b3:b15','b3:b9','b2:b16','b2:b11','b2:b15','b2:b7','b2:b12','b2:b3'};

inputs=char(sheetnames(8));
inputr=char(ranges(8));
inputr2=char(ranges2(8));

lookback=252;
[names date price]=blp_simple('input_sector_small',inputs,inputr,lookback); %import data set from bloomberg
...
xlswrite('coint_result_2013_0605',stk1_col,inputs,'b1');
xlswrite('coint_result_2013_0605',stk2_col,inputs,'c1');
xlswrite('coint_result_2013_0605',[NUM_T TR AR HP WinP B abs(B) RSQR STAT L SL SC abs(SC)],inputs,'d2');
